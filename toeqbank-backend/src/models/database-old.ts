...
let poolConfig: any = {
  ...
  max: 20, // Maximum pool connections (increased from 10)
  min: 0,  // Minimum pool connections (reduced from 2)
  idle: 30000, // Close idle clients after 30 seconds (increased from 10)
  connectionTimeoutMillis: 10000, // Return error if no connection within 10 seconds (increased from 5)
  idleTimeoutMillis: 30000, // Close idle connections after 30 seconds (increased from 10)
  query_timeout: 60000, // Query timeout 60 seconds (increased from 30)
  statement_timeout: 60000 // Statement timeout 60 seconds (increased from 30)
};
...
export const query = async (text: string, params?: any[]): Promise<any> => {
  let client: any = null;
  try {
    // Use a timeout for getting the connection
